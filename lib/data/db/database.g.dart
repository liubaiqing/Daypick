...
class $EventsTable extends Events with TableInfo<$EventsTable, Event> {
  ...
  @override
  late final GeneratedColumnWithTypeConverter<EventSourceType, int> sourceType =
      GeneratedColumn<int>(
        'source_type',
        aliasedName,
        false,
        type: DriftSqlType.int,
        requiredDuringInsert: true,
      ).withConverter<EventSourceType>($EventsTable.$convertersourceType);
  ...
  Event map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Event(
      ...
      sourceType: $EventsTable.$convertersourceType.fromSql(
  ...
  static JsonTypeConverter2<EventSourceType, int, int> $convertersourceType =
      const EnumIndexConverter<EventSourceType>(EventSourceType.values);
}
...
class Event extends DataClass implements Insertable<Event> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    }
    {
      map['source_type'] = Variable<int>(
        $EventsTable.$convertersourceType.toSql(sourceType),
      );
    }
  ...
  factory Event.fromJson(
    ...
    return Event(
      ...
      sourceType: $EventsTable.$convertersourceType.fromJson(
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'sourceType': serializer.toJson<int>(
        $EventsTable.$convertersourceType.toJson(sourceType),
      ),
...
class EventsCompanion extends UpdateCompanion<Event> {
  ...
  final Value<EventSourceType> sourceType;
  ...
  EventsCompanion.insert({
    ...
    this.allDay = const Value.absent(),
    this.note = const Value.absent(),
    required EventSourceType sourceType,
    this.sourceText = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
    this.deletedAt = const Value.absent(),
  ...
  EventsCompanion copyWith({
    ...
    Value<bool>? allDay,
    Value<String?>? note,
    Value<EventSourceType>? sourceType,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (sourceType.present) {
      map['source_type'] = Variable<int>(
        $EventsTable.$convertersourceType.toSql(sourceType.value),
      );
    }
...
class $$EventsTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<EventSourceType, EventSourceType, int>
...
class $$EventsTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<EventSourceType, int> get sourceType =>
      $composableBuilder(
        column: $table.sourceType,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String?> note = const Value.absent(),
                Value<EventSourceType> sourceType = const Value.absent(),
                Value<String?> sourceText = const Value.absent(),
